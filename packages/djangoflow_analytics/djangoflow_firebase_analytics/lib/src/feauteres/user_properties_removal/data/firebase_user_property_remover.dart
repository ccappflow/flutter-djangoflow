...
class FirebaseUserPropertyRemover implements AnalyticActionPerformer<FirebaseRemovableUserProperty> {
  ...
  @override
  void performAction(FirebaseRemovableUserProperty action) {
