...
abstract class AppLaunchDetails with _$AppLaunchDetails {
  ...
  factory AppLaunchDetails.fromJson(Map<String, dynamic> json) => _$AppLaunchDetailsFromJson(json);
}
...
abstract class BrandDetails with _$BrandDetails {
  ...
  factory BrandDetails.fromJson(Map<String, dynamic> json) => _$BrandDetailsFromJson(json);
}
...
abstract class ThemeDetails with _$ThemeDetails {
  ...
  factory ThemeDetails.fromJson(Map<String, dynamic> json) => _$ThemeDetailsFromJson(json);
}
...
abstract class UpdatesDetails with _$UpdatesDetails {
  ...
  factory UpdatesDetails.fromJson(Map<String, dynamic> json) => _$UpdatesDetailsFromJson(json);
}
...
abstract class LogoDetails with _$LogoDetails {
  ...
  factory LogoDetails.fromJson(Map<String, dynamic> json) => _$LogoDetailsFromJson(json);
}
...
abstract class VersionDetails with _$VersionDetails {
  ...
  factory VersionDetails.fromJson(Map<String, dynamic> json) => _$VersionDetailsFromJson(json);
}
